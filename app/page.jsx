          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            ...
            <div className="flex flex-col mt-[80px] xl:flex-row items-center gap-8">
              ...
              className="uppercase flex items-center gap-2">
                <a href="https://drive.google.com/file/d/1KYTtLIPzwUFEJAvM0dkFBQHoyMq5f9RA/view?usp=sharing" target="_blank" class="cta" download="Rashi_Kulshreshtha_resume">View Resume</a>
