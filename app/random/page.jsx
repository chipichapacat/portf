...
const Random = () => {
    return (
        <div className='relative w-[100%] min-h-[90vh] p-2 bg-primary overflow-hidden flex items-center justify-center'>
            <div className="w-[100%] h-[650px] xl:max-w-[60%] -mt-5  bg-white/60 z-10 rounded-2xl  overflow-hidden md:grid md:grid-cols-2 sm:flex-1">
                <div className="contact-info bg-[#27272c] p-7 pt-[100px]">
                    ...
                    <div className="info items-center justify-between">
                        <div className="information mt-10 gap-8 justify-left bg-[#27272c] text-white rounded-full flex items-center">
                            ...
                            <div>
                                ...
                                <h3 className="text-lg">(+91) 6393037184</h3>
                            </div>
                        </div>
                        <div className="information mt-10 gap-10 justify-left bg-[#27272c] text-white rounded-full flex items-center">
                            ...
                            <div>
                                ...
                                <h3 className="text-lg">rashikulshreshtha23@gmail.com</h3>
                            </div>
                        </div>
                        <div className="information mt-10  gap-10 justify-left bg-[#27272c] text-white rounded-full flex items-center">
                            <div className="bg-primary rounded-full p-4">
                            ...
                            <div>
                                ...
                                <h3 className="text-lg">Bhopal, Madhya Pradesh</h3>
                            </div>
                        </div>
                ...
                <div className="contact-form sm:pt-10 bg-gradient-to-l from-accent to-primary relative before:content-[''] before:absolute before:w-[26px] before:h-[26px] before:bg-primary before:rotate-45 before:top-[50px] before:-left-[13px]">
                    
                    <div className=" order-2 xl:order-none ">
                        <form className="flex flex-col gap-6 px-10 py-2 bg-transparent rounded-xl">
                            <h3 className="text-5xl mb-3 font-extrabold text-black ">Let's work <span className="text-white">together</span></h3>
                            ...
                            {/* button */}
                            <Button size="md" className="max-w-[200px] bg-primary text-accent gap-4 hover:bg-[#27272c] hover:text-accent-hover">
                                <p>Send Meesage</p>
